...
{
    public class Level1 : LibCut.Universe.Levels.Level
    {
        /// <summary>
        ...
        public Level1(ContentManager _content, GraphicsDevice _graphicsDevice, LibCut.Universe.Levels.LevelState.LevelState _levelState)
        ...
        public override void Reset()
        {
            ...
            BG = new Things.Background.Background(this, Content.Load<Texture2D>(@"Backgrounds/Level1BG"), 100);
